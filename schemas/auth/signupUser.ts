  ...
  z
    .object({
      name: z
        .string()
        .min(3, {
          message: getTranslation("errorMessages.shared.nameTooShort"),
        })
        .max(50, {
          message: getTranslation("errorMessages.shared.nameTooLong"),
        }),

      username: z
        .string()
        .min(3, {
          message: getTranslation("errorMessages.shared.usernameTooShort"),
        })
        .max(50, {
          message: getTranslation("errorMessages.shared.usernameTooLong"),
        }),
...
export const USER_SIGN_UP_FORM_SCHEMA_WITH_EFFECTS = () =>
  USER_SIGN_UP_FORM_SCHEMA()
    ...
    .transform((data) => {
      const { sameAsWhatsapp, password, confirmPassword, ...rest } = data;
